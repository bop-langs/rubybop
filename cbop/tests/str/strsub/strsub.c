...
int main(int argc, char *argv[]) {
	//printf("%s\n",strsub("my name is inigo montoya you killed my father prepare to die","father","mother"));
	//printf("%s\n",strsub("a man a plan a canal panama","an","q"));
	//printf("%s\n",strsub("a man a plan a canal panama","man","can"));
